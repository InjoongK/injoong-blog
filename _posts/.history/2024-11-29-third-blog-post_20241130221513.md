...
<div style="text-align: center;">
  <img src="https://injoongk.github.io/injoong-blog/assets/img/streamlit_main.png" alt="Main Page of Streamlit" width="900" height="400">
</div>
...
- **Number of players to display**: Allows users to control how many top-performing players to show in the Power Metrics Overview section. By entering a value, users can adjust the number of players displayed in the rankings based on metrics like Home Runs per At Bat (HR/AB) or Isolated Power (ISO). The number can be adjusted between 1 and the total number of players in the dataset.
