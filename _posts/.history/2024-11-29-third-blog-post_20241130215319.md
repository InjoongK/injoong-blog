...
You can easily make your own streamlit app, too. See the <a href=https://docs.streamlit.io/> document tab on the Streamlit website </a>, and also for those interested in the code, you can find it in my <a href="https://github.com/InjoongK/Streamlit/blob/main/blog_post_3_streamlit.py"> GitHub Repository</a>.
